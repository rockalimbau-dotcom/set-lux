...
describe('runtime utils', () => {
  ...
  describe('readCondParams', () => {
    ...
    it('should read parameters from localStorage', () => {
      ...
      expect(mockLocalStorage.getItem).toHaveBeenCalledWith('cond_test-project_semanal');
      expect(result).toEqual({
        jornadaTrabajo: 8,
        jornadaComida: 0.5,
        cortesiaMin: 30,
    ...
    it('should try mensual key if semanal fails', () => {
      ...
      expect(mockLocalStorage.getItem).toHaveBeenCalledWith('cond_test-project_semanal');
      expect(mockLocalStorage.getItem).toHaveBeenCalledWith('cond_test-project_mensual');
