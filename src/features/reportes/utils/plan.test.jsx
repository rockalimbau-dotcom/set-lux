...
// Mock text utilities
vi.mock('./text.ts', () => ({
  norm: vi.fn((str) => String(str || '').toLowerCase().trim()),
}));
...
describe('plan utils', () => {
  ...
  describe('refWorksOnBlock', () => {
    ...
    it('should return false for rest day', () => {
      ...
      const result = refWorksOnBlock(mockFindWeekAndDay, '2024-01-15', 'Juan', 'base');
    ...
    it('should check prelight list for pre block', () => {
      const day = {
        tipo: 'Trabajo',
        prelight: [
          { name: 'Carlos', role: 'REF' },
        ],
      };
      mockFindWeekAndDay.mockReturnValue({ day });
      
      const result = refWorksOnBlock(mockFindWeekAndDay, '2024-01-15', 'Carlos', 'pre');
    ...
    it('should check pickup list for pick block', () => {
      const day = {
        tipo: 'Trabajo',
        pickup: [
          { name: 'Ana', role: 'REFUERZO' },
        ],
      };
      mockFindWeekAndDay.mockReturnValue({ day });
      
      const result = refWorksOnBlock(mockFindWeekAndDay, '2024-01-15', 'Ana', 'pick');
  ...
  describe('isPersonScheduledOnBlock', () => {
    ...
    it('should return false for rest day', () => {
      ...
      const result = isPersonScheduledOnBlock('2024-01-15', 'DIRECTOR', 'Juan', mockFindWeekAndDay);
    ...
    it('should handle REF role with blockForRef', () => {
      ...
      const result = isPersonScheduledOnBlock('2024-01-15', 'REF', 'Juan', mockFindWeekAndDay, 'base');
    ...
    it('should check prelight for P suffix role', () => {
      const day = {
        tipo: 'Trabajo',
        prelight: [
          { name: 'Juan', role: 'DIRECTOR' },
        ],
      };
      mockFindWeekAndDay.mockReturnValue({ day });
      
      const result = isPersonScheduledOnBlock('2024-01-15', 'DIRECTORP', 'Juan', mockFindWeekAndDay);
    ...
    it('should check pickup for R suffix role', () => {
      const day = {
        tipo: 'Trabajo',
        pickup: [
          { name: 'María', role: 'PRODUCTOR' },
        ],
      };
      mockFindWeekAndDay.mockReturnValue({ day });
      
      const result = isPersonScheduledOnBlock('2024-01-15', 'PRODUCTORR', 'María', mockFindWeekAndDay);
    ...
    it('should check team for base role', () => {
      ...
      const result = isPersonScheduledOnBlock('2024-01-15', 'TÉCNICO', 'Carlos', mockFindWeekAndDay);
    ...
    it('should match role and name correctly', () => {
      ...
      expect(() => {
        isPersonScheduledOnBlock('2024-01-15', 'DIRECTOR', 'Juan', mockFindWeekAndDay);
      }).not.toThrow();
    });
  });
  ...
  describe('blockKeyForPerson', () => {
    ...
    it('should return "pre" for P suffix role', () => {
      const result = blockKeyForPerson('2024-01-15', 'DIRECTORP', 'Juan', mockFindWeekAndDay);
      
      expect(result).toBe('pre');
    });

    it('should return "pick" for R suffix role', () => {
      const result = blockKeyForPerson('2024-01-15', 'PRODUCTORR', 'María', mockFindWeekAndDay);
      
      expect(result).toBe('pick');
    });

    it('should return "base" for regular role', () => {
      const result = blockKeyForPerson('2024-01-15', 'TÉCNICO', 'Carlos', mockFindWeekAndDay);
  ...
  describe('personWorksOn', () => {
    ...
    it('should return false for rest day', () => {
      ...
      const result = personWorksOn(mockFindWeekAndDay, '2024-01-15', 'DIRECTOR', 'Juan');
    ...
    it('should check all lists for REF role', () => {
      ...
      const result = personWorksOn(mockFindWeekAndDay, '2024-01-15', 'REF', 'Juan');
    ...
    it('should check prelight for P suffix role', () => {
      ...
      const result = personWorksOn(mockFindWeekAndDay, '2024-01-15', 'DIRECTORP', 'Juan');
    ...
    it('should check pickup for R suffix role', () => {
      ...
      const result = personWorksOn(mockFindWeekAndDay, '2024-01-15', 'PRODUCTORR', 'María');
    ...
    it('should check team for base role', () => {
      ...
      const result = personWorksOn(mockFindWeekAndDay, '2024-01-15', 'TÉCNICO', 'Carlos');
  ...
  describe('isOffForPerson', () => {
    ...
    it('should return true for null day', () => {
      ...
      const result = isOffForPerson(mockFindWeekAndDay, '2024-01-15', 'DIRECTOR', 'Juan');
