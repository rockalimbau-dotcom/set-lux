  ...
  return {
    useLocalStorage: (key, initial) => {
      if (String(key || '').startsWith('plan_')) {
        if (globalThis.__TEST_PLAN__) return [globalThis.__TEST_PLAN__, vi.fn()];
      }
      try {
...
const planKeyFor = (project) => `plan_${project?.id || project?.nombre || 'demo'}`;
...
describe('ReportesTab (smoke)', () => {
  ...
  it('renders week content when Planificación has data and people', () => {
    ...
    const week = {
      ...
      days: [
        { start: '08:00', end: '17:00', team: [{ role: 'EL', name: 'Juan' }], prelight: [], pickup: [] },
        { start: '08:00', end: '17:00', team: [{ role: 'EL', name: 'Juan' }], prelight: [], pickup: [] },
        { start: '08:00', end: '17:00', team: [{ role: 'EL', name: 'Juan' }], prelight: [], pickup: [] },
        { start: '08:00', end: '17:00', team: [{ role: 'EL', name: 'Juan' }], prelight: [], pickup: [] },
        { start: '08:00', end: '17:00', team: [{ role: 'EL', name: 'Juan' }], prelight: [], pickup: [] },
