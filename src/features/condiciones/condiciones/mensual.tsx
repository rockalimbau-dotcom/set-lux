...
const defaultFestivos = `La jornada y horas en días festivos tendrán un incremento del 75%. (Festivos Cataluña 2025: 1/01, 6/01, 29/03, 01/04, 01/05, 24/06, 15/08, 11/09, 12/10, 1/11, 06/12, 25/12, 26/12)`;
