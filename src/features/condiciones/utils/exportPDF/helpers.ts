...
function translateHeader(header: string): string {
  const headerMap: Record<string, string> = {
    ...
    'Precio Festivo': i18n.t('conditions.priceHoliday'),
    'Precio Día extra/Festivo': i18n.t('conditions.priceHoliday'),
    'Sexto día': i18n.t('conditions.priceSixthDay'),
    'Sexto día 1/2 jornada': i18n.t('conditions.priceSixthDayHalf'),
