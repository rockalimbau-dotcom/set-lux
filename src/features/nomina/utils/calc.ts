...
export function makeRolePrices(project: any) {
  ...
  switch (projectType) {
    ...
    case 'publicidad':
      return makeRolePricesSemanal(project); // Temporalmente usar semanal
    case 'semanal':
    default:
...
export function aggregateReports(project: any, weeks: any[], filterISO: ((iso: string) => boolean) | null = null) {
  ...
  switch (projectType) {
    ...
    case 'publicidad':
      return aggregateReportsSemanal(project, weeks, filterISO); // Temporalmente usar semanal
    case 'semanal':
    default:
...
export function getCondParams(project: any) {
  ...
  switch (projectType) {
    ...
    case 'publicidad':
      return getCondParamsSemanal(project); // Temporalmente usar semanal
    case 'semanal':
    default:
...
export function getOvertimeWindowForPayrollMonth(project: any, monthKey: string) {
  ...
  switch (projectType) {
    ...
    case 'publicidad':
      return getOvertimeWindowForPayrollMonthSemanal(project, monthKey); // Usar semanal como base
    case 'semanal':
    default:
      return getOvertimeWindowForPayrollMonthSemanal(project, monthKey);
  }
...
export function aggregateWindowedReport(project: any, weeks: any[], filterISO: (iso: string) => boolean) {
  ...
  switch (projectType) {
    ...
    case 'publicidad':
      return aggregateWindowedReportSemanal(project, weeks, filterISO); // Temporalmente usar semanal
    case 'semanal':
    default:
